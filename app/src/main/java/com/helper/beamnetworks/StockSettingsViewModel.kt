...
data class StockSettingItem(
    val name: String = "",
    val quantity: Long = 0,
    val minStockLevel: Long = 0
)

class StockSettingsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _stockSettingItems = MutableStateFlow<List<StockSettingItem>>(emptyList())
    val stockSettingItems: StateFlow<List<StockSettingItem>> = _stockSettingItems
    ...
    private fun combineData() {
        ...
        _stockSettingItems.value = combinedList
    }
